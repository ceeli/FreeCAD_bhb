...
__title__ = "_TaskPanelFemElementRotation1D"
__author__ = "Bernd Hahnebach"
__url__ = "http://www.freecadweb.org"

## @package TaskPanelFemElementRotation1D
#  \ingroup FEM
...
class _TaskPanelFemElementRotation1D:
    ...
    def __init__(self, obj):
        ...
        self.form = FreeCADGui.PySideUic.loadUi(FreeCAD.getHomePath() + "Mod/Fem/PyGui/TaskPanelFemElementRotation1D.ui")
